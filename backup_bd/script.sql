...
--
-- Name: tb_order_tem; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tb_order_tem (
...
--
-- Name: tb_order_tem tb_order_tem_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_order_tem
    ADD CONSTRAINT tb_order_tem_pkey PRIMARY KEY (order_id, product_id);
...
--
-- Name: tb_order_tem fkhqdfotj71ljpu2sf9gmp360gm; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_order_tem
    ADD CONSTRAINT fkhqdfotj71ljpu2sf9gmp360gm FOREIGN KEY (product_id) REFERENCES public.tb_product(id);
...
--
-- Name: tb_order_tem fkt9fjmj04o3gf3y42tkhi18bp4; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_order_tem
    ADD CONSTRAINT fkt9fjmj04o3gf3y42tkhi18bp4 FOREIGN KEY (order_id) REFERENCES public.tb_order(id);
